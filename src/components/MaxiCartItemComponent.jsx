...
import {maxiAllProducts} from '../helpers/maxiProducts';

const MaxiCartItemComponent = ({item}) => {
  ...
  const productImage = maxiAllProducts.find(p => p.name === item.name)?.image;
...
export default MaxiCartItemComponent;
